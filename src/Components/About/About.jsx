...
const About = () => {
    return (
        <div id='about-section'>
            <div className='about-wrapper flex flex-col-reverse md:flex-row text-slate-800'>
