...
const CurvyDividerBottom = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full absolute -bottom-3 fill-amber-200 z-0">
        ...
        <path fill-opacity="1" d="M0,288L48,288C96,288,192,288,288,240C384,192,480,96,576,101.3C672,107,768,213,864,234.7C960,256,1056,192,1152,165.3C1248,139,1344,149,1392,154.7L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z" filter='url(#shadow)'/>
    </svg>
);
const Contact = () => {
    return (
