    ...
    return (
        <div className='w-full md:w-1/2 text-slate-800 pt-6 p-5 md:p-10'>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 mt-5">
                ...
                <a href="https://github.com/arshil-amaan" target='_blank' rel="noopener noreferrer" title="Visit my Github" className="flex items-center justify-center cursor-pointer md:w-fit w-1/4 transition-transform duration-300 hover:gap-2 hover:-translate-x-1 hover:-translate-y-1 active:translate-x-1 active:translate-y-1 active:shadow-none">
                    <GitHub className='rounded-full hover:shadow-[4px_4px_7px_#cab76e]' style={iconStyles} />
                </a>
                <a href="https://www.linkedin.com/in/arshil-amaan/" target='_blank' rel="noopener noreferrer" title="Visit my LinkedIn" className="flex items-center justify-center cursor-pointer md:w-fit w-1/4 transition-transform duration-300 hover:gap-2 hover:-translate-x-1 hover:-translate-y-1 active:translate-x-1 active:translate-y-1 active:shadow-none">
                    <LinkedIn className='rounded-full hover:shadow-[4px_4px_7px_#cab76e]' style={iconStyles} />
                </a>
                <a href="mailto:arshilamaanansari@gmail.com" target='_blank' rel="noopener noreferrer" title="Mail me" className="flex items-center justify-center cursor-pointer md:w-fit w-1/4 transition-transform duration-300 hover:gap-2 hover:-translate-x-1 hover:-translate-y-1 active:translate-x-1 active:translate-y-1 active:shadow-none">
                    <Email className='rounded-full hover:shadow-[4px_4px_7px_#cab76e]' style={iconStyles} />
                </a>
                <a href="tel:+91-7786989680" title="Call me" className="flex items-center justify-center cursor-pointer md:w-fit w-1/4 transition-transform duration-300 hover:gap-2 hover:-translate-x-1 hover:-translate-y-1 active:translate-x-1 active:translate-y-1 active:shadow-none">
                    <Phone className='rounded-full hover:shadow-[4px_4px_7px_#cab76e]' style={iconStyles} />
                </a>
                <a href="https://wa.me/917786989680" target='_blank' rel="noopener noreferrer" title="WhatsApp me" className="flex items-center justify-center cursor-pointer md:w-fit w-1/4 transition-transform duration-300 hover:gap-2 hover:-translate-x-1 hover:-translate-y-1 active:translate-x-1 active:translate-y-1 active:shadow-none">
