...
const SkillCard = ({ tooltip, tech }) => {
  ...
  return (
    <div className="relative inline-block cursor-pointer group">
      ...
      <div className="absolute z-10 bottom-full left-1/3 transform -translate-x-1/2 w-[260px] bg-gray-800 text-white text-center rounded-lg py-1 opacity-0 visibility-hidden transition-opacity duration-300 ease-in-out group-hover:opacity-100 group-hover:visibility-visible font-sans">
